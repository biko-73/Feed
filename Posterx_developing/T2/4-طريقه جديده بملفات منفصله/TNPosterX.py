# -*- coding: utf-8 -*-
# TNPosterX.py - عرض البوستر للحدث الحالي والمقبل
...
# --- تعيين FOLDERS ووظيفة log ---
from Components.Renderer.TN_Utils import setup_folders
FOLDERS, LOG_FILE = setup_folders("TN_X")
