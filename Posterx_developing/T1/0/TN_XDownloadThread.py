# -*- coding: utf-8 -*-
# TN_XDownloadThread.py
# Universal Graphics Downloader for TN_X
...
class TN_XDownloadThread(threading.Thread):
	def __init__(self):
...
def auto_clean_thread():
	while True:
		...
		try:
			from Components.Renderer.TN_X import poster_path, backdrop_path, banner_path, logo_path
			clean_old_files(poster_path)
			clean_old_files(backdrop_path)
			clean_old_files(banner_path)
			clean_old_files(logo_path)
		except:
			pass
