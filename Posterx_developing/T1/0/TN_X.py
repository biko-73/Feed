...
from Components.Renderer.TN_XDownloadThread import TN_XDownloadThread
...
# --- خيط التنزيل ---
class PosterDB(TN_XDownloadThread):
	def __init__(self):
		TN_XDownloadThread.__init__(self)
