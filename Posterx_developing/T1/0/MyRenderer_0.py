# -*- coding: utf-8 -*-
# MyRenderer - Universal Graphics Renderer
...
from Components.Renderer.MyRendererDownloadThread import MyRendererDownloadThread
...
def get_media_folder():
	...
	for path in paths:
		if os.path.isdir(path) and os.access(path, os.W_OK):
			base_folder = f"{path}/MyRenderer/"
			os.makedirs(base_folder, exist_ok=True)
			return base_folder
	return "/tmp/MyRenderer/"
...
# --- خيط التنزيل ---
class PosterDB(MyRendererDownloadThread):
	def __init__(self):
		MyRendererDownloadThread.__init__(self)
