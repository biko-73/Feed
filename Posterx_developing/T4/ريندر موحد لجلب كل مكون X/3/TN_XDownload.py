...
# ✅ تأكد أن علامات التنصيص مستقيمة تمامًا هنا
...
class TN_X_Downloader(threading.Thread):
    ...
    def download_all(self, item):
        ...
        # تحديد ترتيب اللغات: عربي أولًا إذا كانت اللغة ar، وإلا إنجليزي أولًا
        if self.lng == "ar":
