...
pending_requests = set()  # يحتوي على clean_name فقط
downloader = None
_active_renderers = []
...
class TN_X(Renderer):
    ...
    def changed(self, what):
        ...
        try:
            ...
            # ✅ تحقق من الاسم النظيف فقط
            if self.clean_name in pending_requests:
            ...
            pending_requests.add(self.clean_name)  # ✅ فقط الاسم النظيف
