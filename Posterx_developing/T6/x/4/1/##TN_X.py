...
def on_item_downloaded(clean_name):
    ...
    # انسخ القائمة لتجنب التغيير أثناء التكرار
    for renderer in list(active_renderers):
        try:
            if hasattr(renderer, "clean_name") and renderer.clean_name == clean_name:
                # تأكد أن الـ instance لا يزال موجودًا وصالحًا
...
class TN_X(Renderer):
    ...
    def changed(self, what):
        ...
        try:
            ...
            # دعم eEPGCache دائمًا للحدث الحالي والقادم
