...
class TN_X(Renderer):
    ...
    def changed(self, what):
        ...
        try:
            ...
            # 1. دعم session.Event_Next مع eEPGCache فقط
            ...
            # 2. إذا لم ينجح eEPGCache، استخدم self.source.event (للحدث الحالي فقط)
            elif hasattr(self.source, "event") and self.source.event and self.nextEvent == 0:
