                    ...
                    if "Event[" in source_str:
                        ...
                        if match:
                            ...
                            if service_ref:
                                ...
                                events = epg.lookupEvent(['RIBDT', (service_ref.toString(), 0, -1, 1200)])
