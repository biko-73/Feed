    ...
    def changed(self, what):
        ...
        try:
            ...
            if self.nexts == 0:
                ...
                # جلب الأحداث من نفس الخدمة
                service = event.getEventName()  # لا نحتاج service فعليًا
                # في الواقع، نعتمد على EPG cache عبر service
                ...
                try:
                    ...
                    pass
                if ref:
                    events = epg.lookupEvent(['IBDCTESX', (ref.toString(), 0, self.nexts + 1, -1)])
